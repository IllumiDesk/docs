---
description: How IllumiDesk works and what sets it apart from other solutions.
---
...
We are just getting started! If you would like to see something added, feel free to [open an issue in our GitHub repo](https://github.com/illumidesk/illumidesk) with the `request` tag.
