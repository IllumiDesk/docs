...
When you first access the Knowledge Base tab in your assistant configuration, you'll see:
...
This will create a new knowledge base specifically for your assistant and automatically connect it.
...
This interface provides three main tools:
...
Individual files: Up to 48MB
Files over 48MB: Automatically split for processing
...
<Card title="Assistant Configuration" icon="settings" href="/user-guide/assistant-configuration">
  Learn how to connect knowledge bases to your assistants.
</Card>

<Card title="Creating Assistants" icon="plus" href="/user-guide/creating-assistants">
  Create AI assistants that can use your knowledge base.
</Card>

<Card title="Data Retrieval Methods" icon="database" href="/concepts/data-retrieval-methods">
  Understand the differences between knowledge base and MCP data access.
</Card>

<Card title="Workspace" icon="layout" href="/user-guide/workspace">
  Use the workspace to interact with your knowledge base data.
</Card>
</CardGroup>
